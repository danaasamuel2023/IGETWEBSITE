        ...
        <nav className="mt-5">
          <div className="px-2 space-y-1">
            ...
            <Link href="/update-prices">
              <span className={`group flex items-center px-4 py-2 text-sm font-medium rounded-md ${router.pathname === '/update-prices' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'} cursor-pointer`}>
                <svg xmlns="http://www.w3.org/2000/svg" className="mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
